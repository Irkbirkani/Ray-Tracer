...
public:
     ...
     *         traceType: The type of trace you wish to run. Includes TRACE, STEREO, SPHERE, CONCAVE, and CONVEX.
    */
    void trace(double z, vector<Sphere> spheres, vector<Quad> quads, Lens lens, Vector3 light, bool DoF, int samples, string file, int traceType)
    {
